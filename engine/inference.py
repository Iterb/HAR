...
def preprocess(cfg, data):
    ...
    if cfg.INFER.ARCH == DOUBLE_LSTM:
        ...
        temporal_features_per1 = create_sequence_for_infer(cfg.INFER.WINDOW_SIZE, features_per1, seq_type)
        temporal_features_per2 = create_sequence_for_infer(cfg.INFER.WINDOW_SIZE, features_per2, seq_type)
    ...
    if cfg.INFER.ARCH == TRIPLE_LSTM:
        ...
        temporal_features_per1 = create_sequence_for_infer(cfg.INFER.WINDOW_SIZE, features_per1, seq_type)
        temporal_features_per2 = create_sequence_for_infer(cfg.INFER.WINDOW_SIZE, features_per2, seq_type)
        temporal_features_dist = create_sequence_for_infer(cfg.INFER.WINDOW_SIZE, dist, seq_type)
