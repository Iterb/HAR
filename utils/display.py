...
def put_interactions_on_video(video_path: str, interactions: np.array, 
                              window_duration: int, window_offset: int,
                              output_path: str):
    ...
    while(True):
        try:
            ...
            cv2.putText(frame, f"{CLASS_DICT[predicted_class]}",
                        (80,80),0, 5e-3 * 200, (0,255,0),2)
